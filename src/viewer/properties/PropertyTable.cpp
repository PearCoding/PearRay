...
void PropertyTable::rec_add(IProperty* property)
{
	...
	mPropertyChangedMapper.setMapping(property, property);
	mPropertyStructureChangedMapper.setMapping(property, property);
	mValueChangedMapper.setMapping(property, property);
...
{
	emit propertyChanged(reinterpret_cast<IProperty*>(obj));
}

void PropertyTable::propertyStructureWasChanged(QObject* obj)
{
	emit propertyStructureChanged(reinterpret_cast<IProperty*>(obj));
}

void PropertyTable::valueWasChanged(QObject* obj)
{
	emit valueChanged(reinterpret_cast<IProperty*>(obj));
}
