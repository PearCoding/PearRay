...
namespace details {
template <bool Side>
inline PR_LIB bool _intersectBaseBW12(
	const Ray& in,
	const float* M,
	float& t, Vector2f& uv)
{
...
template <bool Side>
inline PR_LIB bfloat _intersectBaseBW12(
	const RayPackage& in,
	const float* M,
...
inline PR_LIB bool intersectLineBW12(
	const Ray& in,
	const float* M)
{
	float t;
...
inline PR_LIB bfloat intersectLineBW12(
	const RayPackage& in,
	const float* M)
{
	vfloat t;
