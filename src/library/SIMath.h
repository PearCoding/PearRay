...
struct SIBase : public SIBaseClass
{
    ...
    SIBase() = default;
    SIBase(const Base &val) : Value(val) {}
...
template <class Unit, typename T = typename std::enable_if<is_unit<Unit>::value>::type>
...
typename std::enable_if<traits::is_unit<Unit>::value, Unit>::type
...
typename std::enable_if<traits::is_unit<Unit1>::value && traits::is_unit<Unit2>::value, typename details::unit_mul<Unit1, Unit2>::type>::type
...
template <typename Unit1, typename Unit2>
typename std::enable_if<traits::is_unit<Unit1>::value && traits::is_unit<Unit2>::value, typename details::unit_div<Unit1, Unit2>::type>::type
operator/(const Unit1 &v1, const Unit2 &v2)
{
    return v1.Value / v2.Value;
}
...
template <typename Unit>
typename std::enable_if<traits::is_unit<Unit>::value, typename details::unit_inv<Unit>::type>::type
operator/(const typename Unit::base_t &b, const Unit &v)
{
    return b / v.Value;
}
