...
PR_TEST("Parent");
{
	...
	root->setRotation(PM::pm_RotationQuatFromXYZ(PM::pm_Set(PM::pm_DegToRad(90), 0, 0)));
	...
	root->setRotation(PM::pm_RotationQuatFromXYZ(PM::pm_Set(0, PM::pm_DegToRad(90), 0)));
	PR_CHECK_NEARLY_EQ_3(child->worldPosition(), PM::pm_Set(0, 5, 0, 1));

	root->setRotation(PM::pm_RotationQuatFromXYZ(PM::pm_Set(0, 0, PM::pm_DegToRad(90))));
