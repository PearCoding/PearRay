...
namespace details {
inline PR_LIB_CORE bool _intersectBasePI_Off(
	const Ray& in,
...
inline PR_LIB_CORE bfloat _intersectBasePI_Off(
	const RayPackage& in,
...
inline PR_LIB_CORE bool intersectLinePI_Off(
	const Ray& in,
	const Vector3f& p0, const Vector3f& p1, const Vector3f& p2)
{
	Vector3f e0, e1;
...
inline PR_LIB_CORE bool intersectPI_Off(
	const Ray& in,
	const Vector3f& p0, const Vector3f& p1, const Vector3f& p2,
	float& t)
{
...
inline PR_LIB_CORE bfloat intersectLinePI_Off(
	const RayPackage& in,
	const Vector3fv& p0, const Vector3fv& p1, const Vector3fv& p2)
{
	Vector3fv e0, e1;
...
inline PR_LIB_CORE bfloat intersectPI_Off(
	const RayPackage& in,
	const Vector3fv& p0, const Vector3fv& p1, const Vector3fv& p2,
	vfloat& t)
{
