...
// Moeller-Trumbore
namespace details {
inline PR_LIB_CORE bool _intersectBaseMT(
	const Ray& in,
...
inline PR_LIB_CORE bfloat _intersectBaseMT(
	const RayPackage& in,
...
inline PR_LIB_CORE bool intersectLineMT(
	const Ray& in,
	const Vector3f& p1, const Vector3f& p2, const Vector3f& p3)
{
	Vector2f uv;
...
inline PR_LIB_CORE bool intersectMT(
	const Ray& in,
	const Vector3f& p1, const Vector3f& p2, const Vector3f& p3,
	float& t)
{
...
inline PR_LIB_CORE bfloat intersectLineMT(
	const RayPackage& in,
	const Vector3fv& p1, const Vector3fv& p2, const Vector3fv& p3)
{
	Vector2fv uv;
...
inline PR_LIB_CORE bfloat intersectMT(
	const RayPackage& in,
	const Vector3fv& p1, const Vector3fv& p2, const Vector3fv& p3,
	vfloat& t)
{
