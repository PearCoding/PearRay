...
namespace details {
inline PR_LIB_CORE bool _intersectBasePI_Mem(
	const Ray& in,
	const Vector3f& p0,
	const Vector3f& p1,
	const Vector3f& p2,
...
///////////////// Vector variant
inline PR_LIB_CORE bfloat _intersectBasePI_Mem(
	const RayPackage& in,
...
inline PR_LIB_CORE bool intersectLinePI_Mem(
	const Ray& in,
	const Vector3f& p0, const Vector3f& p1, const Vector3f& p2,
	const Vector3f& m0, const Vector3f& m1, const Vector3f& m2)
{
...
inline PR_LIB_CORE bool intersectPI_Mem(
	const Ray& in,
	const Vector3f& p0, const Vector3f& p1, const Vector3f& p2,
	const Vector3f& m0, const Vector3f& m1, const Vector3f& m2,
	float& t)
...
inline PR_LIB_CORE bfloat intersectLinePI_Mem(
	const RayPackage& in,
	const Vector3fv& p0, const Vector3fv& p1, const Vector3fv& p2,
	const Vector3fv& m0, const Vector3fv& m1, const Vector3fv& m2)
{
...
inline PR_LIB_CORE bfloat intersectPI_Mem(
	const RayPackage& in,
	const Vector3fv& p0, const Vector3fv& p1, const Vector3fv& p2,
	const Vector3fv& m0, const Vector3fv& m1, const Vector3fv& m2,
	vfloat& t)
