...
template <bool Side>
inline PR_LIB_CORE bool _intersectBaseBW9(
	const Ray& in,
	const float* M,
	int fixedColumn,
	float& t,
...
template <bool Side>
inline PR_LIB_CORE bfloat _intersectBaseBW9(
	const RayPackage& in,
	const float* M,
	int fixedColumn,
	vfloat& t,
...
inline PR_LIB_CORE bool intersectLineBW9(
	const Ray& in,
	const float* M,
	int fixedColumn)
{
...
inline PR_LIB_CORE bool intersectBW9(
	const Ray& in,
	const float* M,
	int fixedColumn,
	float& t)
...
inline PR_LIB_CORE bfloat intersectLineBW9(
	const RayPackage& in,
	const float* M,
	int fixedColumn)
{
...
inline PR_LIB_CORE bfloat intersectBW9(
	const RayPackage& in,
	const float* M,
	int fixedColumn,
	vfloat& t)
