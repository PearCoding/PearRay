...
namespace details {
inline PR_LIB_CORE bool _intersectBaseWT(
	const Ray& in,
...
inline PR_LIB_CORE bfloat _intersectBaseWT(
	const RayPackage& in,
	const Vector3fv& p1,
	const Vector3fv& p2,
	const Vector3fv& p3,
...
inline PR_LIB_CORE bool intersectLineWT(
	const Ray& in,
	const Vector3f& p1, const Vector3f& p2, const Vector3f& p3)
{
	float t, det, u, v;
...
inline PR_LIB_CORE bool intersectWT(
	const Ray& in,
	const Vector3f& p1, const Vector3f& p2, const Vector3f& p3,
	float& t)
{
...
inline PR_LIB_CORE bfloat intersectLineWT(
	const RayPackage& in,
...
inline PR_LIB_CORE bfloat intersectWT(
	const RayPackage& in,
	const Vector3fv& p1, const Vector3fv& p2, const Vector3fv& p3,
	vfloat& t)
{
